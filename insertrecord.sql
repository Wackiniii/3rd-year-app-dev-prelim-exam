...
(8, 'Carlos', 'Valdez', 'carlos.valdez@example.com', '09171234508', CURRENT_TIMESTAMP),
(9, 'Maria', 'Santos', 'maria.santos@example.com', '09171234509', CURRENT_TIMESTAMP),
(10, 'Daniel', 'Kim', 'daniel.kim@example.com', '09171234510', CURRENT_TIMESTAMP),
(11, 'Beatriz', 'Morales', 'beatriz.m@example.com', '09171234511', CURRENT_TIMESTAMP),
(12, 'Rafael', 'Navarro', 'rafael.n@example.com', '09171234512', CURRENT_TIMESTAMP);
...
(8, 1, 'Electric Guitar', 'Gibson Les Paul Standard 50s', 'GLP50-881920', CURRENT_TIMESTAMP), 
(9, 2, 'Acoustic Guitar', 'Martin D-28 Standard', 'MD28-301948', CURRENT_TIMESTAMP),       
(10, 8, 'Saxophone', 'Selmer Paris Series II Alto', 'SP2A-992140', CURRENT_TIMESTAMP),
(11, 8, 'Saxophone', 'Yamaha YTS-62 Tenor', 'YTS62-550192', CURRENT_TIMESTAMP),            
(12, 9, 'Keyboard / Synth', 'Roland Fantom-08', 'RF08-551029', CURRENT_TIMESTAMP),
(13, 10, 'Bass Guitar', 'Fender Player Precision Bass', 'MX22910481', CURRENT_TIMESTAMP),
(14, 11, 'Electric Guitar', 'Ibanez Prestige RG5121', 'IPRG-220199', CURRENT_TIMESTAMP);
...
(10, 'Full Repad & Cork Overhaul', 'Woodwinds', 4.50, CURRENT_TIMESTAMP);
...
(8, 8, 1, 2, 'completed', 'Heavy fret buzz along frets 12-15 after change to heavier gauge strings', 210.00, '2026-08-16', '2026-08-18', CURRENT_TIMESTAMP),
(9, 10, 3, 10, 'in-progress', 'Worn neck cork and leaking lower stack pads', 280.00, '2026-08-18', NULL, CURRENT_TIMESTAMP),
(10, 9, 1, 1, 'completed', 'Standard setup and high action correction at the nut', 75.00, '2026-08-19', '2026-08-20', CURRENT_TIMESTAMP),
(11, 11, 3, 5, 'in-progress', 'Sticky G# key pad and loose octave mechanism pivot pin', 260.00, '2026-08-20', NULL, CURRENT_TIMESTAMP),
(12, 5, 3, 10, 'checked-in', 'Complete overhaul requested following long storage period', 280.00, '2026-08-21', NULL, CURRENT_TIMESTAMP),
(13, 12, 6, 4, 'waiting-parts', 'Defective pitch bend wheel assembly and unresponsive F#4 key', 195.00, '2026-08-22', NULL, CURRENT_TIMESTAMP),
(14, 14, 1, 8, 'completed', 'Truss rod adjustment and new string gauge installation', 50.00, '2026-08-23', '2026-08-24', CURRENT_TIMESTAMP),
(15, 1, 2, 9, 'checked-in', 'Shielding cavity installation and full rewire with vintage cloth wire', 130.00, '2026-08-24', NULL, CURRENT_TIMESTAMP),
(16, 13, 9, 3, 'completed', 'Scratchy blend potentiometer and loose output jack terminal', 120.00, '2026-08-25', '2026-08-26', CURRENT_TIMESTAMP);
